...
import { LayoutDashboard, Users, Building2, ShoppingCart, FileText, CreditCard, Bot, Activity, Settings, LogOut, Globe, BarChart3, Link as LinkIcon, MessageSquare } from 'lucide-react';
...
const menuItems = [
  ...
  { title: 'Sales Inquiries', icon: MessageSquare, href: '/admin/sales-inquiries' },
