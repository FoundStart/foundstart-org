 ...
 * Non-partnered entries are skipped (they live in the glossary as plain text).
 */
          ...
          return (
            <Card key={p.id} className="hover:border-primary/50 transition-colors">
              <CardContent className="p-5 flex flex-col h-full">
                ...
                {!v.ok && showWarnings && v.message && (
                  <p className="mt-2 text-xs text-destructive">{v.message}</p>
                )}
              </CardContent>
            </Card>
          );
 ...
 * partnered CTAs + non-partnered mentions across all categories.
 */
